        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="#" class="btn btn-success btn-sm float-right" data-toggle="modal" data-target="#addBrandModal"><i
                            ...
                            @foreach ($brands as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" wire:click="editBrand({{ $item }})" data-toggle="modal" data-target="#editBrandModal" title="Edit"><button
...
@include('livewire.backend.brand.modal-form')
</div>

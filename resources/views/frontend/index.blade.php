    ...
    <section class="hero-slider">
        <div class="hero-items owl-carousel">
            @foreach ($sliders as $item)
                <div class="single-slider-item set-bg" data-setbg="{{ !empty($item->image) ? URL::to('storage/' . $item->image) : URL::to('image/no_image.png') }}">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 p-5 transparent-background " >
                                <h3>{{ $item->title }}</h3>
